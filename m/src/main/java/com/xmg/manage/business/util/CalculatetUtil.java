package com.xmg.manage.business.util;
...
public class CalculatetUtil {
	...
	public static BigDecimal calTotalInterest(int returnType, BigDecimal bidRequestAmount, BigDecimal yearRate, int monthes2Return) {
		...
		if (returnType == BidConst.RETURN_TYPE_MONTH_INTEREST_PRINCIPAL) {// 按月分期
			...
			BigDecimal monthlyInterest = com.xmg.manage.business.util.DecimalFormatUtil.amountFormat(bidRequestAmount.multiply(monthlyRate));
			totalInterest = monthlyInterest.multiply(new BigDecimal(monthes2Return));
		}
		return com.xmg.manage.business.util.DecimalFormatUtil.formatBigDecimal(totalInterest, BidConst.STORE_SCALE);
	}
	...
	public static BigDecimal calMonthlyInterest(int returnType, BigDecimal bidRequestAmount, BigDecimal yearRate, int monthIndex, int monthes2Return) {
		...
		if (returnType == BidConst.RETURN_TYPE_MONTH_INTEREST_PRINCIPAL) {// 按月分期
			...
			monthlyInterest = com.xmg.manage.business.util.DecimalFormatUtil.amountFormat(bidRequestAmount.multiply(monthlyRate));
		}
	...
	public static BigDecimal calMonthToReturnMoney(int returnType, BigDecimal bidRequestAmount, BigDecimal yearRate, int monthIndex, int monthes2Return) {
		...
		return com.xmg.manage.business.util.DecimalFormatUtil.formatBigDecimal(monthToReturnMoney, BidConst.STORE_SCALE);
	}
	...
	public static BigDecimal calBidInterest(BigDecimal bidRequestAmount, int monthes2Return, BigDecimal yearRate, int returnType, BigDecimal acturalBidAmount) {
		...
		return com.xmg.manage.business.util.DecimalFormatUtil.formatBigDecimal(bidInterest, BidConst.STORE_SCALE);
	}
...
//	}
	...
	public static BigDecimal calInterestManagerCharge(BigDecimal interest) {
		return com.xmg.manage.business.util.DecimalFormatUtil.formatBigDecimal(
	...
	public static BigDecimal calAccountManagementCharge(
		...
		BigDecimal accountManagementCharge = com.xmg.manage.business.util.DecimalFormatUtil
				.formatBigDecimal(
