...
public class BidRequestController {
	...
	@Autowired
	private com.xmg.manage.business.service.IBidRequestService bidRequestService;
	...
	public String bidRequestPublishAuditList(
			@ModelAttribute("qo") com.xmg.manage.business.query.BidRequestQueryObject qo, Model model) {
	...
	public String borrowInfoDetail(Long id, Model model) {
		// bidRequest;
		com.xmg.manage.business.domain.BidRequest bidRequest = this.bidRequestService.get(id);
